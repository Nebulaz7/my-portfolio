  ...
  return (
    <section className="about-section" ref={sectionRef}  id="about">
      ...
      <div className="about-container">
        <div className={`about-image-container ${isImageVisible ? 'visible' : ''}`}>
          <img 
            src={nebulaImage} 
            alt="Profile" 
        ...
        <div className={`about-content ${isContentVisible ? 'visible' : ''}`}>
          ...
          <div className="about-description">
            ...
            <p>
                I'm  also a student of Computer Science at the Federal University of Agriculture, Abeokuta.
                I'm a passionate developer with expertise in building modern web applications,
                With a focus on React, TypeScript and css. I strive to create
                user-friendly experiences that are both functional and aesthetically pleasing.
